 ...
 */
class Stupid_Simple_Countdown_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/stupid-simple-countdown-public.css', array(), $this->version, 'all' );
